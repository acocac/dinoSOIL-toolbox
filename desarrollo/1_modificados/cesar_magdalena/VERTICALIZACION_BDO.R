...
data <- data.frame(read_excel("/Volumes/Alejo/Users/ac/Documents/Consultancy/IGAC/projects/3_mapeosuelos/desarrollos/soil-toolbox/proyecto_cesarmagdalena/datos/entrada/0_basededatos/BD_PERFILES_MODELAMIENTO_PT_2020.xlsx", sheet = "ORIGINAL", na = "N/A"),row.names="COD_PERFIL")
