...
# Cargan de datos
data <- read.csv('/Volumes/Alejo/Users/ac/Documents/Consultancy/IGAC/projects/3_mapeosuelos/desarrollos/soil-toolbox/proyecto_cesarmagdalena/datos/salida/0_matriz/MatrixDatos.csv', sep=',')#lee los datos
...
datap1$clima<-gsub(14,"(Templado, h�medo)",datap1$Clima)
datap1$clima<-gsub(13,"(Subnival, Pluvial)",datap1$clima)
datap1$clima<-gsub(1, "(C�lido, h�medo)",datap1$clima)
datap1$clima<-gsub(2, "(C�lido, muy seco)",datap1$clima)
datap1$clima<-gsub(3, "(C�lido, seco)",datap1$clima)
datap1$clima<-gsub(7, "(Fr�o, h�medo)",datap1$clima)
...
ggplot(datap1, aes(y=ph1_spline1, x=MRRTF, colour=clima)) + 
  ...
  xlab("�ndice multiresoluci�n de la planitud superior de la cresta")+
  ylab("Ph, nivel:0-30,Spline")+
  geom_point()
...
ggplot(datap1, aes(y=ph1_spline1, x=ndvi, colour=clima)) + 
  ...
  xlab("Ind. de Vegetaci�n Diferencia Normalizada ")+
  ylab("Ph, nivel:0-30,Spline")+
  geom_point()

#############################################################
##DIAGRAMAS DE DISPERSION CON RESPECTO AL tipo de relieve
#SUGERENCIA: La interpretaci�n de las variables respecto al
...
datap1$Relieve<-gsub(21,"(Cono de deyecci�n)",datap1$Relieve)
datap1$Relieve<-gsub(1, "(Terraza aluvial nivel 1)",datap1$Relieve)
datap1$Relieve<-gsub(2, "(Colina)",datap1$Relieve)
datap1$Relieve<-gsub(3, "(Glacis de acumulaci�n)",datap1$Relieve)
datap1$Relieve<-gsub(4, "(Loma)",datap1$Relieve)
datap1$Relieve<-gsub(5, "(Valle estrecho)",datap1$Relieve)
datap1$Relieve<-gsub(6, "(Depresi�n)",datap1$Relieve)
datap1$Relieve<-gsub(7, "(Vallecito)",datap1$Relieve)
datap1$Relieve<-gsub(8, "(Plano de inundaci�n de r�o me�ndrico activo)",datap1$Relieve)
datap1$Relieve<-gsub(9, "(Plano de inundaci�n de r�o me�ndrico inactivo)",datap1$Relieve)
...
ggplot(datap1, aes(y=ph1_spline1, x=Pos_Op, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, spline)Vs.Ubicaci�n paisaje") +
...
ggplot(datap1, aes(y=ph1_spline1, x=ndvi, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, spline)Vs.ndvi") +
  xlab("Indice de Vegetaci�n de la Diferencia Normalizada ")+
  ylab("Ph, nivel:0-30,Spline")+
  geom_point()
...
ggplot(data = datap1,aes(x=clima,y =DEM)) +
  ylab("Modelo digital de elevaci�n")+
  ggtitle('Boxplot DEM') + 
...
ggplot(data = datap1, aes(x=clima, y =MRRTF)) +
  ylab("�ndice multiresoluci�n de la planitud superior de la cresta")+
  ggtitle('Boxplot �ndice multiresoluci�n de la planitud superior de la cresta')+
  geom_boxplot(aes(fill=clima)) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
...
ggplot(data = datap1, aes(x =clima, y =ndvi)) +
  ylab("Indice de Vegetaci�n de la Diferencia Normalizada")+
  ggtitle('Boxplot Indice de Vegetaci�n de la Diferencia Normalizada')+
  geom_boxplot(aes(fill=clima)) +
  theme(axis.title.x=element_blank(),
        axis.text.x=element_blank(),
        axis.ticks.x=element_blank())
