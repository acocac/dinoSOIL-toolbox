...
#                  Victoria Camacho (Estadística), Patricia Escudero (Estadística), Andrés Rosso (PhD Ingenieria, experto en Machine Learning), Yesenia Vargas (MSc Geografia, experta en Proyectos);
...
# actualización: v1 Bogotá, Colombia - Septiembre 2020;
...
r.dir  =  ' / Usuarios / ac / Documentos / Consultoría / IGAC / proyectos / 3_mapeosuelos / desarrollos / suelo-toolbox / src '

# ## Directorio del proyecto ### #copiar la ruta completa donde se aloja el proyecto (carpeta proyecto)
# Indicar la ruta al proyecto
proyecto.dir  =  ' / Usuarios / ac / Documentos / Consultoría / IGAC / proyectos / 3_mapeosuelos / desarrollos / suelo-toolbox / proyecto_sibundoy '
...
COV <- stack("COV_SIBU.tif")#Los vectores de apilamiento concatenan m�ltiples vectores en un solo vector junto con un factor que indica d�nde se origin� cada observaci�n
