##Analisis exploratorio, variable PH.0_30_sumasponderadas###
#Carga de paquetes#
...
names(data)#nombre de las variables de la base data
nrow(data)#numero de filas de la base data


####Omitir variables que no son de interes
datap <- data[,-c(1:13,15,21)] %>% na.omit
names(datap)#nombre de la base datap
length(datap)#tamaño de la base datap
View(datap)#ver la base datap
str(datap)#ver los primero seis datos de la base datap

#arreglo de variables, nuevos nombres y se vuelven as.numeric
ph1_sum.pond1<-as.numeric(datap$pH.0_30_Sum.Pond)
...
datap1<-data.frame(ph1_sum.pond1, DEM, AnHill, Slope, Aspect, CNBL, Conv_Ind,
                   CSC, FA, LC, LSfactor, MRRTF, MRVBF, Neg_Op, Pos_Op, RSP, skyVF,
                   TRI, TPI, TWI, VD, VDCN, visSky, ndvi, tipo_relieve, Clima)
class(datap1$Clima)#tipo de la variable clima
datap1$Clima<-as.factor(datap1$Clima)#se vuelve factor la variable clima
...
ncol(datap1)#numero de columnas de la variable datap1
View(datap1)#ver la base datap1

##################################################################
##Correlaciones de la variable PH (0-30, SPLINE) con las demas covariables
matrixcor<-data.frame(ph1_sum.pond1, DEM, AnHill, Slope, Aspect, CNBL, Conv_Ind,
                      CSC, FA, LC, LSfactor, MRRTF, MRVBF, Neg_Op, Pos_Op, RSP, skyVF,
...
ggplot(data=datap1, aes(x=DEM, y=ph1_sum.pond1, colour=clima)) +
  geom_point() +
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. DEM") +
  xlab("Modelo Digital de Elevación")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")

#Variable PH con AnHill
ggplot(datap1, aes(y=ph1_sum.pond1, x=AnHill, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. AnHill") +
  xlab("Analytical Hillshade")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#Variable PH con Slope
ggplot(datap1, aes(y=ph1_sum.pond1, x=Slope, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. Slope") +
  xlab("Slope")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con Aspect
ggplot(datap1, aes(y=ph1_sum.pond1, x=Aspect, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. Aspect") +
  xlab("Aspecto")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con CNBL
ggplot(datap1, aes(y=ph1_sum.pond1, x=CNBL, colour=clima)) +
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.CNBL") +
  xlab("channel network base level")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con Conv_Ind
ggplot(datap1, aes(y=ph1_sum.pond1, x=Conv_Ind, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Conv_Ind") +
  xlab("Convergence Index")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con CSC
ggplot(datap1, aes(y=ph1_sum.pond1, x=CSC, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.CSC") +
  xlab("Cross Sectional Curvature")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con FLOWACCUMULATION
ggplot(datap1, aes(y=ph1_sum.pond1, x=FA, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Flow Accum.") +
  xlab("Flow Accumulation")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con LONGITUDINALCURVATURE
ggplot(datap1, aes(y=ph1_sum.pond1, x=LC, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Long.Curv.") +
  xlab("Longitudinal Curvature")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con LSFactor
ggplot(datap1, aes(y=ph1_sum.pond1, x=LSfactor, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Factor LS") +
  xlab("Factor LS")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con MRRTF
ggplot(datap1, aes(y=ph1_sum.pond1, x=MRRTF, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.MRRTF") +
  xlab("Indice multiresolucion de la planitud superior de la cresta")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con MRVBF
ggplot(datap1, aes(y=ph1_sum.pond1, x=MRVBF, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.MRVBF") +
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=Neg_Op, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Negative Openness") +
  xlab("Negative Openness")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con Pos_op
ggplot(datap1, aes(y=ph1_sum.pond1, x=Pos_Op, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Positive Openness") +
  xlab("Positive Openness")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con RSP
ggplot(datap1, aes(y=ph1_sum.pond1, x=RSP, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.RSP") +
  xlab("Relative Slope Position")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con SkyVF
ggplot(datap1, aes(y=ph1_sum.pond1, x=skyVF, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.skyVF") +
  xlab("Sky View Factor")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con TRI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TRI, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.TRI") +
  xlab("Terrain Ruggedness Index")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con TPI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TPI, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.TPI") +
  xlab("Topographic Position Index ")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con TWI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TWI, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.TWI") +
  xlab("Topographic wetness index")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()

#variable PH con VD
ggplot(datap1, aes(y=ph1_sum.pond1, x=VD, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Velley Depth") +
  xlab("Velley Depth")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  labs(fill="Clima")+
  geom_point()
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=VDCN, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.VDCN") +
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=visSky, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Visible Sky") +
  xlab("Visible Sky")+
  ylab("Ph, nivel:0-30, Sum.Ponderada")+
  geom_point()
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=ndvi, colour=clima)) + 
  labs(fill="Clima")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.ndvi") +
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=DEM, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.DEM") +
  xlab("Modelo digital de elevación")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#Variable PH con AnHill
ggplot(datap1, aes(y=ph1_sum.pond1, x=AnHill, colour=Relieve)) +
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. AnHill") +
  xlab("Analytical Hillshade")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#Variable PH con Slo
ggplot(datap1, aes(y=ph1_sum.pond1, x=Slope, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. Slo") +
  xlab("Slope")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()

#variable PH con Aspect
ggplot(datap1, aes(y=ph1_sum.pond1, x=Aspect, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs. Aspect") +
  xlab("Aspecto")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con CNBL
ggplot(datap1, aes(y=ph1_sum.pond1, x=CNBL, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Channel Network Base Level") +
  xlab("Channel Network Base Level")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()
...
#variable PH con Conv_Ind
ggplot(datap1, aes(y=ph1_sum.pond1, x=Conv_Ind, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Convergence Index") +
  xlab("Convergence Index")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=CSC, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.CSC") +
  xlab("Cross Sectional Curvature")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con FA
ggplot(datap1, aes(y=ph1_sum.pond1, x=FA, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.") +
  xlab("Flow Accum")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()
...
ggplot(datap1, aes(y=ph1_sum.pond1, x=LC, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.LC") +
  xlab("Longitudinal Curvature")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()
...
#variable PH con LSFactor
ggplot(datap1, aes(y=ph1_sum.pond1, x=LSfactor, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Factor LS") +
  xlab("Factor LS")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con MRRTF
ggplot(datap1, aes(y=ph1_sum.pond1, x=MRRTF, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.MRRTF") +
...
#variable PH con MRVBF
ggplot(datap1, aes(y=ph1_sum.pond1, x=MRVBF, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.MRVBF") +
  xlab("Multiresolution Index of Valley Bottom Flatness")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con neg_op
ggplot(datap1, aes(y=ph1_sum.pond1, x=Neg_Op, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Ubic.Paisaje") +
  xlab("Ubic.Paisaje Negativo")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()

#variable PH con Pos_op
ggplot(datap1, aes(y=ph1_sum.pond1, x=Pos_Op, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Ubicación paisaje") +
  xlab("Ubic. Paisaje positivo")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()

#variable PH con RSP
ggplot(datap1, aes(y=ph1_sum.pond1, x=RSP, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.RSP") +
  xlab("Relative Slope Position")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con SkyVF
ggplot(datap1, aes(y=ph1_sum.pond1, x=skyVF, colour=Relieve)) +
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.skyVF") +
  xlab("Sky View Factor")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con TRI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TRI, colour=Relieve)) +
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.TRI") +
  xlab("Terrain Ruggedness Index")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con TPI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TPI, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.TPI") +
...
#variable PH con TWI
ggplot(datap1, aes(y=ph1_sum.pond1, x=TWI, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Topographic Wetness Index") +
  xlab("Topographic Wetness Index")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()
...
#variable PH con VD
ggplot(datap1, aes(y=ph1_sum.pond1, x=VD, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Velley Depth") +
  xlab("Velley Depth")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con VDCN
ggplot(datap1, aes(y=ph1_sum.pond1, x=VDCN, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Vertical Distance Channel Network") +
  xlab("Vertical Distance Channel Network")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
  geom_point()

#variable PH con visSky
ggplot(datap1, aes(y=ph1_sum.pond1, x=visSky, colour=Relieve)) +
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.Visible Sky") +
  xlab("Visible Sky")+
  ylab("Ph, nivel:0-30,Sum.Ponderada")+
...
#variable PH con ndvi
ggplot(datap1, aes(y=ph1_sum.pond1, x=ndvi, colour=Relieve)) + 
  labs(fill="Relieve")+
  ggtitle("PH(0-30, Sum.Ponderada)Vs.ndvi") +
...
ggplot(data = datap1, aes(x =clima, y =ph1_sum.pond1)) +
  ylab("Ph,nivel:0-30,Sum.Ponderada")+
  ggtitle('Boxplot Ph,nivel:0-30,Sum.Ponderada')+
