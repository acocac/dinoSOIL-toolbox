...
#'   \code{tgt_proj}.
#' @param resampling_method Character. One of \code{"near"},
...
#'   \code{tgt_proj}.
#' @param buffer Numeric. Add buffer (specified in units of \code{tgt_proj}).
...
#' @param return_rast Logical. Return \code{RaserLayer} to R?
#' @param overwrite Logical. Should \code{outfile} be overwritten if it already
#'   exists?
